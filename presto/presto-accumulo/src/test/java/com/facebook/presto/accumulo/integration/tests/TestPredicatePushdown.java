...
public class TestPredicatePushdown
{
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(Long.valueOf(0), BIGINT)
                .addField(Long.valueOf(60), BIGINT);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(null, BIGINT)
                .addField(Long.valueOf(60), BIGINT);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Long.valueOf(30), BIGINT)
                .addField(Long.valueOf(60), BIGINT);
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(Long.valueOf(0), BIGINT);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(Long.valueOf(15), BIGINT);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Long.valueOf(30), BIGINT);
            ...
            throws Exception
    {
        ...
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(Long.valueOf(15), BIGINT);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Long.valueOf(30), BIGINT);
        Row r4 = Row.newRow().addField("row4", VARCHAR).addField(Long.valueOf(-15), BIGINT);
        Row r5 = Row.newRow().addField("row5", VARCHAR).addField(Long.valueOf(45), BIGINT);
            ...
            throws Exception
    {
        ...
        Row r4 = Row.newRow().addField("row4", VARCHAR).addField(Long.valueOf(-15), BIGINT);
        Row r5 = Row.newRow().addField("row5", VARCHAR).addField(Long.valueOf(45), BIGINT);
        Row r6 = Row.newRow().addField("row6", VARCHAR).addField(Long.valueOf(60), BIGINT);
        Row r7 = Row.newRow().addField("row7", VARCHAR).addField(Long.valueOf(90), BIGINT);
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(Long.valueOf(0), BIGINT)
                .addField(Long.valueOf(0), BIGINT);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(Long.valueOf(15), BIGINT)
                .addField(Long.valueOf(15), BIGINT);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Long.valueOf(30), BIGINT)
                .addField(Long.valueOf(30), BIGINT);
        Row r4 = Row.newRow().addField("row4", VARCHAR).addField(Long.valueOf(-15), BIGINT)
                .addField(Long.valueOf(-15), BIGINT);
        Row r5 = Row.newRow().addField("row5", VARCHAR).addField(Long.valueOf(45), BIGINT)
                .addField(Long.valueOf(45), BIGINT);
        Row r6 = Row.newRow().addField("row6", VARCHAR).addField(Long.valueOf(60), BIGINT)
                .addField(Long.valueOf(60), BIGINT);
        Row r7 = Row.newRow().addField("row7", VARCHAR).addField(Long.valueOf(90), BIGINT)
                .addField(Long.valueOf(90), BIGINT);
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(Double.valueOf(0), DOUBLE)
                .addField(Double.valueOf(60), DOUBLE);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(null, DOUBLE)
                .addField(Double.valueOf(60), DOUBLE);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Double.valueOf(30), DOUBLE)
                .addField(Double.valueOf(60), DOUBLE);
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(Double.valueOf(0), DOUBLE);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(Double.valueOf(15), DOUBLE);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Double.valueOf(30), DOUBLE);
            ...
            throws Exception
    {
        ...
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(Double.valueOf(15), DOUBLE);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Double.valueOf(30), DOUBLE);
        Row r4 = Row.newRow().addField("row4", VARCHAR).addField(Double.valueOf(-15), DOUBLE);
        Row r5 = Row.newRow().addField("row5", VARCHAR).addField(Double.valueOf(45), DOUBLE);
            ...
            throws Exception
    {
        ...
        Row r4 = Row.newRow().addField("row4", VARCHAR).addField(Double.valueOf(-15), DOUBLE);
        Row r5 = Row.newRow().addField("row5", VARCHAR).addField(Double.valueOf(45), DOUBLE);
        Row r6 = Row.newRow().addField("row6", VARCHAR).addField(Double.valueOf(60), DOUBLE);
        Row r7 = Row.newRow().addField("row7", VARCHAR).addField(Double.valueOf(90), DOUBLE);
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(Double.valueOf(0), DOUBLE)
                .addField(Double.valueOf(0), DOUBLE);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(Double.valueOf(15), DOUBLE)
                .addField(Double.valueOf(15), DOUBLE);
        Row r3 = Row.newRow().addField("row3", VARCHAR).addField(Double.valueOf(30), DOUBLE)
                .addField(Double.valueOf(30), DOUBLE);
        Row r4 = Row.newRow().addField("row4", VARCHAR).addField(Double.valueOf(-15), DOUBLE)
                .addField(Double.valueOf(-15), DOUBLE);
        Row r5 = Row.newRow().addField("row5", VARCHAR).addField(Double.valueOf(45), DOUBLE)
                .addField(Double.valueOf(45), DOUBLE);
        Row r6 = Row.newRow().addField("row6", VARCHAR).addField(Double.valueOf(60), DOUBLE)
                .addField(Double.valueOf(60), DOUBLE);
        Row r7 = Row.newRow().addField("row7", VARCHAR).addField(Double.valueOf(90), DOUBLE)
                .addField(Double.valueOf(90), DOUBLE);
    ...
    @Test
    public void testSelectArrayWhereNull()
            throws Exception
    {
    ...
    @Test
    public void testSelectArrayWhereNotNull()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayWhereNullOrEqual()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayLess()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayLessOrEqual()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayEqual()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayGreater()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayGreaterOrEqual()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayLessAndGreater()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayLessEqualAndGreater()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayLessAndGreaterEqual()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    public void testSelectArrayLessEqualAndGreaterEqual()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayWithOr()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectArrayInRange()
            throws Exception
    {
        ArrayType arrayType = new ArrayType(VARCHAR);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectMapWhereNull()
            throws Exception
    {
    ...
    @Test
    public void testSelectMapWhereNotNull()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    @Test
    public void testSelectMapWhereNullOrEqual()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR)
    ...
    // registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapLessOrEqual()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    @Test
    public void testSelectMapEqual()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapGreater()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // not registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapGreaterOrEqual()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapLessAndGreater()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapLessEqualAndGreater()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // not registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapLessAndGreaterEqual()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // not registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapLessEqualAndGreaterEqual()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    // registered
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapWithOr()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    @Test(expectedExceptions = SQLException.class)
    public void testSelectMapInRange()
            throws Exception
    {
        MapType mapType = new MapType(VARCHAR, BIGINT);
        RowSchema schema = RowSchema.newRowSchema().addRowId("recordkey", VARCHAR).addColumn("ages",
    ...
    {
        return new GregorianCalendar(y, mo - 1, d, h, mi, s).getTime().getTime();
    }
}
