...
public class TpchDBGenIngest
{
    ...
    private static final RowSchema NATION_SCHEMA = RowSchema.newInstance().addColumn("nationkey", null, null, BIGINT).addColumn("name", "md", "name", VARCHAR, true).addColumn("regionkey", "md", "regionkey", BIGINT).addColumn("comment", "md", "comment", VARCHAR);
    ...
    private static final RowSchema PARTSUPP_SCHEMA = RowSchema.newInstance().addColumn("uuid", null, null, VARCHAR).addColumn("partkey", "md", "partkey", BIGINT, true).addColumn("suppkey", "md", "suppkey", BIGINT).addColumn("availqty", "md", "availqty", BIGINT).addColumn("supplycost", "md", "supplycost", DOUBLE).addColumn("comment", "md", "comment", VARCHAR);

    private static final RowSchema REGION_SCHEMA = RowSchema.newInstance().addColumn("regionkey", null, null, BIGINT).addColumn("name", "md", "name", VARCHAR, true).addColumn("comment", "md", "comment", VARCHAR);

    private static final RowSchema SUPPLIER_SCHEMA = RowSchema.newInstance().addColumn("suppkey", null, null, BIGINT).addColumn("name", "md", "name", VARCHAR, true).addColumn("address", "md", "address", VARCHAR).addColumn("nationkey", "md", "nationkey", BIGINT).addColumn("phone", "md", "phone", VARCHAR).addColumn("acctbal", "md", "acctbal", DOUBLE).addColumn("comment", "md", "comment", VARCHAR);
