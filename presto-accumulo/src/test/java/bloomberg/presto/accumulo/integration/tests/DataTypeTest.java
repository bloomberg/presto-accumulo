...
public class DataTypeTest
{
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(new Long(28), BIGINT);
        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(new Long(0), BIGINT);
            ...
            throws Exception
    {
        ...
        Row r1 = Row.newRow().addField("row1", VARCHAR).addField(new Double(28.1234), DOUBLE);

        Row r2 = Row.newRow().addField("row2", VARCHAR).addField(new Double(-123.1234), DOUBLE);
