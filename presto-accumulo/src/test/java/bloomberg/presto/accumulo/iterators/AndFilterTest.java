...
{
    IteratorSetting cq1gt3 = new IteratorSetting(1, "1", SingleColumnValueFilter.class, getProperties("cf1", "cq1", CompareOp.GREATER, encode(BigintType.BIGINT, 3L)));

    IteratorSetting cq1lt10 = new IteratorSetting(2, "2", SingleColumnValueFilter.class, getProperties("cf1", "cq1", CompareOp.LESS, encode(BigintType.BIGINT, 10L)));

    IteratorSetting cq2lt10 = new IteratorSetting(2, "2", SingleColumnValueFilter.class, getProperties("cf1", "cq2", CompareOp.LESS, encode(BigintType.BIGINT, 10L)));
            ...
            throws IOException
    {
        ...
        TestKeyValueIterator iter = new TestKeyValueIterator(k("row1", "cf1", "cq1"), v(BigintType.BIGINT, 4L));
            ...
            throws IOException
    {
        ...
        iter.clear().add(k("row1", "cf1", "cq1"), v(BigintType.BIGINT, 10L)).add(k("row1", "cf1", "cq2"), v(BigintType.BIGINT, 8L));
        filter = new AndFilter();
        filter.init(iter, settings.getOptions(), null);
        Assert.assertTrue(filter.acceptRow(iter));

        iter.clear().add(k("row1", "cf1", "cq1"), v(BigintType.BIGINT, 3L)).add(k("row1", "cf1", "cq2"), v(BigintType.BIGINT, 8L));
        filter = new AndFilter();
        filter.init(iter, settings.getOptions(), null);
        Assert.assertFalse(filter.acceptRow(iter));

        iter.clear().add(k("row1", "cf1", "cq1"), v(BigintType.BIGINT, 4L)).add(k("row1", "cf1", "cq2"), v(BigintType.BIGINT, 10L));
        filter = new AndFilter();
        filter.init(iter, settings.getOptions(), null);
        Assert.assertFalse(filter.acceptRow(iter));
    }
    ...
    {
        return new Value(LexicoderRowSerializer.encode(t, o));
    }
}
